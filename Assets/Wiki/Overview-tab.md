...
Two buttons produce a printable document in your browser:

* **Print component list** — the table above, as you see it
* **Print BOM** — a bill of materials, with the components grouped and counted
...
Both print what is currently shown, so any filter you have applied carries over.

## Choosing what appears

Each row has a tick box deciding whether that component appears in the printed lists, and there is a
tick-all box in the header. Everything starts ticked, so untick the parts you do not want — connectors
and mechanical items, say — before printing.
