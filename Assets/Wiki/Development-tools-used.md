...
As of March-2026 I have primarily used the `Gemini 3.1 Pro` model, but also `Claude Sonnet 4.6` and in some cases `GPT-5.3-Codex` (these models will of course change for the future).

As of August-2026 I have setup Claude Code (agent), and is primarily using `Sonnet 5` and `Opus 5`.
